...
public class Registrationform extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        names = new javax.swing.JFormattedTextField();
        ...
        jLabel1.setText("UNIVERSITY OF RWANDA REGISTRATION FORM");

        JNAMES.setForeground(new java.awt.Color(51, 51, 0));
        JNAMES.setText("Names");
    ...
    private void bsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsaveActionPerformed
        ...
        String url= "jdbc:mysql://localhost:3306/university of rwanda";
        
        try{
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection connect = DriverManager.getConnection(url, "root", "");
            PreparedStatement pst = connect.prepareStatement("insert into students values (?,?,?,?)");
            pst.setString(1, names.getText());
             pst.setString(2, gender.getSelectedItem().toString()); 
             pst.setString(3, Username.getText());
              pst.setString(4, Password.getText());
             pst.executeUpdate();
            JOptionPane.showMessageDialog(this, "data saved succeful");
        }
...
// TODO add your handling code here:
    ...
    private javax.swing.JFormattedTextField names;
